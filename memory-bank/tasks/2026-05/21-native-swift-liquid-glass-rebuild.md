...
**Status:** 🚧 In progress — Dashboard + package detail + Settings + data layer done and building clean; inspector resize hardened; remaining panels pending. **First commit landed 2026-05-31** (`native/` tree + this task record + memory-bank docs).
